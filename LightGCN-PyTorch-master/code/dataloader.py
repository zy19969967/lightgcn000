...
class MyDataset1(BasicDataset):
    def __init__(self, path):
        ...
        self.Graph = None
        print(
            f"MyDataset Sparsity : {(self.trainDataSize + self.valDataSize + self.testDataSize) / self.n_users / self.m_items}")
    ...
    def load_data(self):
        ...
        self._valdataSize = len(self.valUser)
        self._testDataSize = len(self.testUser)
        self.n_user = len(user_mapping)
        self.m_item = len(item_mapping)
